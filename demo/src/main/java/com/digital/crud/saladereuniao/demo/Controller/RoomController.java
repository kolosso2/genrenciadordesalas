package com.digital.crud.saladereuniao.demo.Controller;

import com.digital.crud.saladereuniao.demo.Exception.ResourceNotFoundException;
import com.digital.crud.saladereuniao.demo.Model.Room;
import com.digital.crud.saladereuniao.demo.Repository.RoomRepository;
...
public class RoomController {
    ...
    public ResponseEntity<Room>updateRoom(@PathVariable (value = "Id") Long roomId,
       ...
       room.setStartHour(roomDetails.getStarHour());
